...
export default function DateDifferenceClient() {
  ...
  const calculateDateDifference = () => {
    ...
    const resultText = `Difference: ${years > 0 ? `${years} year${years > 1 ? 's' : ''}, ` : ''}${months > 0 ? `${months} month${months > 1 ? 's' : ''}, ` : ''}${days} day${days > 1 ? 's' : ''} (${totalDays} total days)`
  ...
  return (
    <Card className="max-w-2xl mx-auto mb-12">
      <div className="space-y-6">
        ...
        {/* Results */}
        {result && !error && (
          <div className="p-4 bg-secondary-bg rounded-lg text-center fade-in">

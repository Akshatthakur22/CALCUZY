      ...
      <main className="container section-responsive">
        ...
        <div className="max-w-4xl mx-auto fade-in-up">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <p className="paragraph">
              ...
              overweight, and obese categories based on World Health Organization standards. For tracking health milestones over time, you might also find our <Link href="/age-calculator" className="link-accent">Age Calculator</Link> useful for calculating precise ages.
            </p>
            ...
            <p className="paragraph">
              ...
              and browsers, making it accessible whenever you need to check your BMI. For planning health-related events or tracking important dates, our <Link href="/date-difference" className="link-accent">Date Difference Calculator</Link> can help you calculate time intervals between medical appointments or health goals.
            </p>
          </div>

          <RelatedTools tools={getRelatedToolsByCategory('calculators', '/bmi-calculator')} />
        </div>
        ...
        <div className="max-w-4xl mx-auto mt-16 fade-in-up">
          ...
          <ul className="list-disc ml-6 mt-4 space-y-2">
            <li className="text-secondary-text"><strong>Weight Management:</strong> Track BMI changes during weight loss programs, monitor progress toward fitness goals, or determine ideal weight ranges for your height</li>
            <li className="text-secondary-text"><strong>Medical Checkups:</strong> Prepare for doctor appointments by knowing your BMI, discuss weight-related health concerns, or track BMI trends over time for preventive care</li>
            <li className="text-secondary-text"><strong>Fitness Planning:</strong> Set realistic fitness goals based on current BMI, calculate target weight for healthy BMI range, or monitor body composition changes during training</li>
            <li className="text-secondary-text"><strong>Nutritional Assessment:</strong> Evaluate if current diet supports healthy weight, determine caloric needs based on BMI category, or plan dietary changes for optimal health</li>
            <li className="text-secondary-text"><strong>Sports Eligibility:</strong> Check BMI requirements for sports participation, qualify for weight-class sports, or meet health standards for athletic programs</li>
            <li className="text-secondary-text"><strong>Family Health:</strong> Monitor family members&apos; BMI trends, assess children&apos;s growth patterns, or identify genetic predispositions to weight-related health issues</li>
          </ul>
        </div>
        ...
        <div className="max-w-4xl mx-auto mt-16">
          ...
          <div className="mt-12 p-6 bg-secondary-bg rounded-xl">
            <h3 className="heading-3 mb-4 text-center">Health & Fitness Tools</h3>
            <p className="paragraph text-center mb-6 text-secondary-text">
              Discover more tools to support your health and wellness journey
            </p>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <Link href="/age-calculator" className="block p-4 bg-white rounded-lg border border-border hover:border-accent transition-colors duration-200">
                <div className="text-center">
                  <div className="text-2xl mb-2">👤</div>
                  <h4 className="font-medium text-primary-text mb-1">Age Calculator</h4>
                  <p className="text-sm text-secondary-text">Calculate your exact age in years, months, and days</p>
                </div>
              </Link>
              <Link href="/ovulation-calculator" className="block p-4 bg-white rounded-lg border border-border hover:border-accent transition-colors duration-200">
                <div className="text-center">
                  ...
                  <p className="text-sm text-secondary-text">Track fertility and calculate fertile days</p>
                </div>
              </Link>
              <Link href="/unit-converter" className="block p-4 bg-white rounded-lg border border-border hover:border-accent transition-colors duration-200">
                <div className="text-center">
                  <div className="text-2xl mb-2">⚖️</div>
                  <h4 className="font-medium text-primary-text mb-1">Unit Converter</h4>
                  <p className="text-sm text-secondary-text">Convert weight and height units for BMI calculations</p>
                </div>
              </Link>
            </div>
          </div>
